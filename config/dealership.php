...
/*
|--------------------------------------------------------------------------
| DealershipMGR store configuration
|--------------------------------------------------------------------------
...
return [
    ...
    'max_width' => env('DEALERSHIP_MAX_WIDTH', 'max-w-7xl'),

    // Storefront identity (Settings -> Storefront overrides all of these).
    'store_name' => 'DealershipMGR',
    'store_tagline' => 'Local Service, Handled',
    'store_email' => null,
    'store_phone' => null,
    'store_address' => null,
    // Business default timezone for scheduling/availability (per-staff can override).
    'timezone' => env('DEALERSHIP_TIMEZONE', 'America/Phoenix'),

    // Money. DealershipMGR stores every amount as an integer in the currency's minor
