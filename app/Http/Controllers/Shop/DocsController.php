    ...
    public function openapi()
    {
        ...
        $doc = [
            ...
            'info' => [
                ...
                'description' => 'Bearer-token REST API for the '.config('brand.name', 'DealershipMGR').' service desk. Rate limit '.$meta['rate_limit'].' requests/minute per token. List endpoints paginate ('.$meta['per_page'].' per page by default, max '.$meta['max_per_page'].').',
            ],
