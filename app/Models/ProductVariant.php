...
class ProductVariant extends Model
{
    ...
    public function getIsInStockAttribute(): bool
    {
        ...
        return $this->inventory_qty > 0 || (bool) config('dealership.allow_backorder');
    }
    ...
    public function getIsLowStockAttribute(): bool
    {
        return $this->track_inventory
            ...
            && $this->inventory_qty <= (int) config('dealership.low_stock_threshold', 5);
    }

    /** How many of this variant a shopper may add, given the stock policy. */
    public function purchasableQuantity(): ?int
    {
        if (! $this->track_inventory || config('dealership.allow_backorder')) {
