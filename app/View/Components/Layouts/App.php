...
class App extends Component
{
    ...
    public function __construct(
        ...
        $this->maxWidth ??= config('dealership.max_width', 'max-w-7xl');
    ...
    private function navigation(): array
    {
        return [
            ...
            [
                ...
                'label' => 'Service Desk',
                'icon' => 'bolt',
                'active' => request()->routeIs('service-requests.*', 'tickets.*', 'quotes.*', 'work-orders.*', 'projects.*', 'vehicles.*', 'inspections.*', 'reminders.*'),
                'items' => [
                    ...
                    ['Estimates', route('quotes.index'), 'document', request()->routeIs('quotes.*')],
                    ['Repair Orders', route('work-orders.index'), 'truck', request()->routeIs('work-orders.*')],
                    ['Vehicles', route('vehicles.index'), 'wrench-screwdriver', request()->routeIs('vehicles.*')],
                    ['Inspections', route('inspections.index'), 'eye', request()->routeIs('inspections.*')],
                    ['Reminders', route('reminders.index'), 'bell', request()->routeIs('reminders.*')],
            ...
            [
                ...
                'label' => 'Parts',
                'icon' => 'box',
                'active' => request()->routeIs('parts.*', 'suppliers.*', 'purchase-orders.*'),
                'items' => [
                    ['Parts', route('parts.index'), 'box', request()->routeIs('parts.*')],
                    ['Suppliers', route('suppliers.index'), 'truck', request()->routeIs('suppliers.*')],
                    ['Purchase Orders', route('purchase-orders.index'), 'document', request()->routeIs('purchase-orders.*')],
                ],
            ],
            [
                'type' => 'link',
            ...
            [
                ...
                'label' => 'Catalog',
                'icon' => 'bag',
                'active' => request()->routeIs('products.*', 'collections.*', 'seo.*', 'canned-jobs.*'),
                'items' => [
                    ['Services', route('products.index'), 'bag', request()->routeIs('products.*')],
                    ['Canned Jobs', route('canned-jobs.index'), 'bolt', request()->routeIs('canned-jobs.*')],
    ...
    private function breadcrumbs(): array
    {
        ...
        $map = [
            ...
            'suppliers' => ['Suppliers', 'suppliers.index'],
            'purchase-orders' => ['Purchase Orders', 'purchase-orders.index'],
            'time' => ['Time Clock', 'time.index'],
