...
{
    protected $signature = 'dealership:license {key? : Set/replace the license key} {--clear : Remove the stored key}';

    protected $description = 'Set, clear, or re-check this install\'s DealershipMGR license (scriptgain.com).';
