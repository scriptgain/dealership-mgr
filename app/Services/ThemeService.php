 ...
 *
 * DealershipMGR has no build step. Tailwind v4 runs in the browser and compiles the
...
class ThemeService
{
    ...
    public function parseImport(string $json): array
    {
        ...
        if (($data['format'] ?? null) !== 'shopmgr.theme') {
            return ['ok' => false, 'error' => 'That JSON is not a DealershipMGR theme export (missing "format": "shopmgr.theme").', 'name' => null, 'description' => null, 'tokens' => []];
        }
    ...
    /**
     * The themes DealershipMGR ships with. "Rose" is the shipped default and
    ...
    public function presets(): array
    {
        return [
            [
                'slug' => 'ember',
                'name' => 'Ember',
                'description' => 'The look DealershipMGR ships with: warm neutral surfaces, deep chrome, energetic orange accent.',
