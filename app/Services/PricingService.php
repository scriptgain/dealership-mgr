...
class PricingService
{
    ...
    public function quote(Cart $cart, ?array $address = null, ?int $rateId = null): array
    {
        ...
        if ($address) {
            $inclusive = config('dealership.tax_mode') === 'inclusive';
            ...
            if ($shippingTotal > 0 && $taxRule?->applies_to_shipping && config('dealership.tax_shipping')) {
        ...
        // double-charge.
        $total = config('dealership.tax_mode') === 'inclusive'
