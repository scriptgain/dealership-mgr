 ...
 *
 * Deliberately NOT the stripe/stripe-php SDK. DealershipMGR needs six endpoints and an
 ...
 *
 * MERCHANT MODEL: direct charges on the merchant's own Stripe account. DealershipMGR
