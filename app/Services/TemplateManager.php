...
class TemplateManager
{
    ...
    /** The template as DealershipMGR ships it, straight off the release's filesystem. */
    ...
    private function helperCheatSheet(): array
    {
        return [
            ...
            ['code' => "\$date->format(config('dealership.date_format'))", 'desc' => "Format a date in the store's chosen format."],
            ['code' => "config('dealership.store_name')", 'desc' => 'Read a store setting.'],
