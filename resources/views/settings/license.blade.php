    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <x-card title="Need A Key?">
                <p class="text-sm text-slate-600">Purchase or manage your subscription at <a href="https://scriptgain.com/products/dealershipmgr" target="_blank" rel="noopener" class="text-brand-700 hover:text-brand-800 font-medium">scriptgain.com</a>.</p>
            </x-card>
        </div>
    </div>
</x-layouts.app>
