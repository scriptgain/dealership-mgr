        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="space-y-4">
                ...
                {{-- Payment. Brand and last four are the only card details
                     DealershipMGR stores; there is nothing else here to show. --}}
                    ...
                    <dl class="space-y-3 text-sm">
                        ...
                        @if ($order->paid_at)
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <dd class="text-slate-900">{{ $order->paid_at->format(config('dealership.date_format').' '.config('dealership.time_format')) }}</dd>
                            </div>
                        @endif
