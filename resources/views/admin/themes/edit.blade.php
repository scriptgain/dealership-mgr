        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-5">
            ...
            <div class="min-w-0 space-y-6 lg:col-span-3">
                ...
                <x-card title="Typography, Corners And Rhythm">
                    <div class="space-y-6">
                        <x-field label="Typeface" for="font_family" hint="Every option is bundled with DealershipMGR or built into the device. Nothing here loads a font from a third party." :error="$errors->first('font_family')">
                        ...
                        <div>
                            ...
                            <p class="mt-1.5 text-sm text-slate-500">0% is fully square, 100% is what DealershipMGR ships, 220% is very soft.</p>
                        </div>
                        ...
                        <div class="th-preview" :style="previewStyle()">
                            ...
                            <div class="th-preview-nav">
                                <span class="th-preview-brand">
                                    ...
                                    <template x-if="! logoPreview">
                                        <span :style="`color:${t.accent}`">{{ config('dealership.store_name') }}</span>
                                    </template>
                                </span>
