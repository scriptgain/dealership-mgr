<x-layouts.app title="Themes">
    ...
    <x-modal name="import-theme" title="Import A Theme" subtitle="Upload a DealershipMGR theme export, or paste its JSON." icon="download" maxWidth="max-w-lg">
        <form method="POST" action="{{ route('themes.import') }}" enctype="multipart/form-data" id="import-theme-form" class="space-y-4">
            @csrf
            <x-field label="Theme File" for="theme-file" hint="A .json file exported from DealershipMGR.">
