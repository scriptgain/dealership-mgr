        ...
        <div class="flex items-start gap-3">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="text-sm {{ $tone['text'] }} opacity-90">{{ $lic['message'] }}
                    Enter or update your key with <code class="font-mono text-xs">php artisan dealership:license &lt;key&gt;</code>,
                    or purchase one at <a href="https://scriptgain.com/products/dealershipmgr" class="underline font-medium" target="_blank" rel="noopener">scriptgain.com</a>.
                </p>
            </div>
        </div>
    </div>
