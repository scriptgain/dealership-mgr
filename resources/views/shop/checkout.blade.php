            ...
            <div class="min-w-0 lg:col-span-2 space-y-10">
                ...
                <div>
                    <label class="flex items-start gap-3 cursor-pointer">
                        <input type="checkbox" name="terms" value="1" @if (config('dealership.terms_required')) required @endif
                        ...
                        <span class="text-sm text-shop-muted">
                            ...
                            @if (config('dealership.terms_required'))<span class="text-rose-500">*</span>@endif
                        </span>
                    </label>
                </div>
            </div>
