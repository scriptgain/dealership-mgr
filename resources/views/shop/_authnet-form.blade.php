...
<div x-data="{
        ...
        pay() {
            this.error = '';
            const parsed = window.dealershipmgrAuthnetParseExpiry(this.card.expiry);
            ...
            const self = this;
            window.dealershipmgrAuthnetPay({
...
@once
    <script>
        ...
        window.dealershipmgrAuthnetParseExpiry = function (raw) {
        ...
        window.dealershipmgrAuthnetPay = function (opts) {
