<x-layouts.shop>
            ...
            <div class="grid items-center gap-14 lg:grid-cols-2 lg:gap-8">
                ...
                <div class="max-w-xl">
                    <p class="inline-flex items-center gap-2 rounded-full bg-brand-50 px-3.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-brand-700 ring-1 ring-inset ring-brand-200">
                        ...
                        {{ config('dealership.store_tagline') }}
                    </p>
                    ...
                    <div class="relative w-full max-w-md rounded-3xl bg-white p-6 text-shop-ink shadow-xl shadow-brand-900/10 ring-1 ring-shop-line">
                        ...
                        <div class="mt-5 flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-xs text-shop-muted">Lead Technician, Bay 2</p>
                            </div>
    ...
    <section class="{{ $maxWidth }} mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach ([
                ['refresh', 'Maintenance', 'Oil and filter, scheduled intervals, fluids, and belts.'],
                ['shield', 'Brakes', 'Pads, rotors, calipers, fluid flushes, and road tests.'],
                ['bolt', 'Diagnostics', 'Check-engine codes, electrical faults, batteries and charging.'],
                ['sync', 'Tires &amp; Alignment', 'Mounting, balancing, rotation, and four-wheel alignment.'],
                ['settings', 'Engine &amp; Drivetrain', 'Timing belts, water pumps, transmission service, and leaks.'],
                ['truck', 'Fleet Service', 'Scheduled servicing and monthly invoicing for work vehicles.'],
            ] as [$icon, $title, $body])
