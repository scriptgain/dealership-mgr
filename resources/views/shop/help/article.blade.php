        ...
        <aside class="min-w-0 lg:col-span-4">
            ...
            @if (config('dealership.store_email'))
                <div class="mt-5 rounded-2xl bg-brand-50 p-5 ring-1 ring-inset ring-brand-200">
                    ...
                    <a href="mailto:{{ config('dealership.store_email') }}" class="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-brand-700 hover:text-brand-800">
                        <x-icon name="envelope" class="h-4 w-4" /> {{ config('dealership.store_email') }}
                    </a>
                </div>
            @endif
        </aside>
