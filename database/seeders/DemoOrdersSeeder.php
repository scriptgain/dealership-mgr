    ...
    private function customerSpecs(): array
    {
        return [
            [
                ...
                'orders' => [
                    ['days_ago' => 96, 'financial' => 'paid', 'fulfillment' => 'delivered', 'gateway' => 'stripe', 'card' => ['visa', '4242'], 'lines' => [['brake-pads-rotors-per-axle', 1], ['brake-fluid-flush', 1]]],
                    ['days_ago' => 63, 'financial' => 'paid', 'fulfillment' => 'delivered', 'gateway' => 'manual', 'lines' => [['oil-filter-change', 1], ['tire-rotation-balance', 2]]],
                    ['days_ago' => 34, 'financial' => 'paid', 'fulfillment' => 'delivered', 'gateway' => 'stripe', 'card' => ['mastercard', '4444'], 'discount_code' => 'FIRSTVISIT10', 'lines' => [['check-engine-diagnostic', 1], ['tire-mount-balance-each', 2]]],
                    ['days_ago' => 11, 'financial' => 'paid', 'fulfillment' => 'shipped', 'gateway' => 'stripe', 'card' => ['visa', '4242'], 'lines' => [['strut-shock-replacement-pair', 1]]],
                    ['days_ago' => 2, 'financial' => 'paid', 'fulfillment' => 'unfulfilled', 'gateway' => 'stripe', 'card' => ['visa', '4242'], 'lines' => [['ac-recharge-leak-test', 1], ['four-wheel-alignment', 1]]],
                ],
            ],
            [
                ...
                'orders' => [
                    ['days_ago' => 51, 'financial' => 'paid', 'fulfillment' => 'delivered', 'gateway' => 'manual', 'lines' => [['four-wheel-alignment', 1]]],
                    ['days_ago' => 7, 'financial' => 'paid', 'fulfillment' => 'shipped', 'gateway' => 'stripe', 'card' => ['amex', '0005'], 'lines' => [['brake-pads-rotors-per-axle', 1]]],
                ],
            ],
            [
                ...
                'orders' => [
                    ['days_ago' => 40, 'financial' => 'refunded', 'fulfillment' => 'returned', 'gateway' => 'stripe', 'card' => ['visa', '4242'], 'note' => 'Compressor was already failing; refunded the recharge.', 'lines' => [['ac-recharge-leak-test', 2]]],
                    ['days_ago' => 15, 'financial' => 'paid', 'fulfillment' => 'delivered', 'gateway' => 'stripe', 'card' => ['visa', '4242'], 'lines' => [['oil-filter-change', 1]]],
                ],
            ],
            [
                ...
                'orders' => [
                    ['days_ago' => 5, 'financial' => 'paid', 'fulfillment' => 'unfulfilled', 'gateway' => 'stripe', 'card' => ['mastercard', '4444'], 'lines' => [['check-engine-diagnostic', 2]]],
                    ['days_ago' => 1, 'financial' => 'pending', 'fulfillment' => 'unfulfilled', 'gateway' => 'manual', 'note' => 'Fleet account — hold for monthly invoicing.', 'lines' => [['tire-mount-balance-each', 3]]],
                ],
            ],
        ];
    }
