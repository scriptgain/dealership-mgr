            ...
            [
                ...
                'articles' => [
                    [
                        ...
                        'body' => "Drop the vehicle at your appointment time and we'll text you when it goes into a bay.\n\nHere's the typical flow:\n\n- **Write-up** — we confirm the concern and what you booked.\n- **Inspection** — a courtesy multi-point check, with photos of anything we flag.\n- **Estimate** — we call or text with the diagnosis and the price before we touch anything.\n- **The work** — with your approval, we get it done and road test it.\n- **Pickup** — we walk you through what we did and what can wait.\n\nIf we find something bigger once we're in, we stop and call you. Nothing gets done without your approval.",
                    ],
                    [
                        'slug' => 'how-to-prepare-your-vehicle',
                        'title' => 'How To Prepare Your Vehicle',
                        'excerpt' => 'A few quick things that help your visit go faster.',
                        'body' => "You don't need to do much, but these help:\n\n- **Clear the trunk and seats** if the work involves the interior or a spare tire.\n- **Note when it happens** — cold start, highway speed, braking, turning.\n- **Bring the codes** if another shop or a parts store already scanned it.\n- **Leave us a key** that works, and tell us about any alarm or kill switch.\n\nThe more detail we start with, the less diagnostic time you pay for.",
                    ],
                    [
            ...
            [
                ...
                'articles' => [
                    [
                        ...
                        'body' => "Before you book, a few basics are worth a look:\n\n- **Gas cap** — loose or cracked caps set the check-engine light on their own.\n- **Tire pressure** — a low tire explains a lot of pulling, wandering and warning lights.\n- **Battery terminals** — corrosion causes slow cranks and odd electrical faults.\n- **Fluid levels** — oil and coolant, checked cold and on level ground.\n\nStill stuck? Book a visit and note what you already tried so we come prepared.",
                    ],
                    [
                        ...
                        'body' => "**Car won't crank** — try the headlights. Bright but no crank points at the starter; dim points at the battery.\n\n**Check-engine light, drives fine** — tighten the gas cap and give it a few drive cycles before booking.\n\n**Squeal that goes away when you brake** — usually the wear indicator telling you pads are near the end.\n\n**AC cold at speed, warm at idle** — often low refrigerant or a failing cooling fan.\n\n**Steering wheel shake at highway speed** — most often wheel balance, sometimes a warped rotor.\n\nIf a quick check doesn't solve it, we're glad to take it from there.",
                    ],
                    [
                        'slug' => 'when-its-an-emergency',
                        'title' => "When It's An Emergency",
                        'excerpt' => 'How to tell an urgent problem from one that can wait.',
                        'body' => "Some things mean stop driving and call us, or call a tow:\n\n- **Brakes going to the floor**, or a grinding pedal.\n- **Temperature gauge in the red**, or steam from under the hood.\n- **Oil pressure or battery warning light** while driving.\n- **A smell of fuel**, or smoke from anywhere.\n- **Steering or suspension that has gone loose or clunky.**\n\nDriving on any of these turns a repair into a much larger one. If you smell fuel or see smoke, get clear of the vehicle first, then call.",
                    ],
                ],
            ],
        ];
